...
import static Components.Toast.ToastClientProperties.*;
import Components.Toast.Utils.UIUtils;
...
public class ToastPanelUI extends BasicPanelUI implements StyleableUI, PropertyChangeListener {
    ...
    protected void installDefaults(JPanel p) {
        ...
        arc = FlatUIUtils.getUIInt(prefix + ".arc", 30);
        ...
        closeButtonIcon = UIUtils.getIcon(prefix + ".closeIcon", UIUtils.createIcon("Components/Toast/SVG/close.svg", closeIconColor, 0.75f));
    ...
    protected Border createDefaultBorder() {
        ...
        float shadowOpacity = FlatUIUtils.getUIFloat("Toast.shadowOpacity", 1f);
